...
public class ReportCreditFragment extends Fragment {

    private static final String TAG = "ReportCreditFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reportInvoiceView = inflater.inflate(R.layout.fragment_credit_report, container, false);
        ...
        final RadioGroup _radioSaleType = (RadioGroup) reportInvoiceView.findViewById(R.id.saleType);
        ...
        _generateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId != -1) {
                    RadioButton radioButtonSelected = (RadioButton) reportInvoiceView.findViewById(selectedId);
                ...
                credit.setFromDate(_fromDate.getText().toString());
                credit.setToDate(_toDate.getText().toString());
                credit.setSaleType(saleType);
                List<CreditVO> credits = dbUtils.getCredits(credit);

                if(credits != null && !credits.isEmpty()) {
                    try {
                        PDFCreator pdfCreator = PDFCreatorFactory.getInstance(GBMConstants.REPORT_CREDIT);
                        File file = pdfCreator.createPDF(getContext(),
                                new SimpleDateFormat("ddMMyyyy").format(myCalendar.getTime()) + ".pdf", credits);
